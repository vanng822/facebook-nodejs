 ...
 *   will be called with the name of signed request cookie. Can be good if application has a letter cookie handler
 */
var destroySession = module.exports.destroySession = function(req, res, clearCookie) {
	...
	var clearCookie = clearCookie || (function(cookieName) {
		try {
			var fbsrCookie = cookieName + '=; path=/; expires=' + new Date(0).toUTCString();
